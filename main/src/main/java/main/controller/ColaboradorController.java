...
public class ColaboradorController {
    ...
    @Autowired
    public ColaboradorController(ActividadService actividadService, UsuarioService usuarioService,ColaboradorService colaboradorService) {
    ...
    public String addActivity(@ModelAttribute("actividad") Actividad actividad,
        ...
        actividad.setColaborador(colaborador); // 🔑 Asignación antes de guardar
